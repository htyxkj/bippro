<template>
  <div class="md-bip-pagination layout-row layout-align-center-center" v-if="pager">
    <md-button class="md-icon-button md-bip-pagination-previous" @click.native="previousPage" :disabled="currentPage === 1">
      <md-icon>keyboard_arrow_left</md-icon>
    </md-button>
    <span class="md-bip-pagination-info">{{pageInfo}}</span>
