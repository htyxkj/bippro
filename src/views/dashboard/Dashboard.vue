...
export default {
  ...
  methods: {
    ...
    fetchTaskData() {
      ...
      this.getDataByAPINew(data1, this.getTaskCallBack, this.getCallError)
    },
    fetchXSData() {
      ...
      this.getDataByAPINew(data1, this.getXSCallBack, this.getCallError)
    },
    getTaskCallBack(res) {
      if (res.data.id == 0) {
        this.taskLayCel = res.data.data.layCels;
